...
<body>
	...
	<div class="container">		
		...
		<a href="listarRestaurantes" class="btn btn-secondary">Voltar</a>
		<form action="cadastrarRestaurante" method="post">
			...
			<div class="col-sm-2">
				...
				<input class="form-control form-control-sm mb-3" type="number" name="raio-atuacao-km" id="id-raio-atuacao-km">
			</div>
